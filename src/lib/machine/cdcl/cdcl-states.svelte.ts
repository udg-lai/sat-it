...
import {
  ...
  type CDCL_BACKTRACKING_FUN,
  type CDCL_BACKTRACKING_INPUT,
  backtracking,
...
> = {
  ...
  transitions: new Map<CDCL_CHECK_NON_DECISION_MADE_INPUT, number>()
    .set('backtracking_state', cdcl_stateName2StateId['backtracking_state'])
    .set('unsat_state', cdcl_stateName2StateId['unsat_state'])
};

const backtracking_state: NonFinalState<CDCL_BACKTRACKING_FUN, CDCL_BACKTRACKING_INPUT> = {
  id: cdcl_stateName2StateId['backtracking_state'],
  run: backtracking,
  description: `Executes a backtracking step`,
  transitions: new Map<CDCL_BACKTRACKING_INPUT, number>().set(
    'complementary_occurrences_state',
    cdcl_stateName2StateId['complementary_occurrences_state']
  )
};
