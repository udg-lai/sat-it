...
export default class OccurrenceTable {
    ...
    private table: SvelteMap<Lit, SvelteSet<ClauseTag>> = new SvelteMap();
    ...
    getTable(): SvelteMap<Lit, SvelteSet<ClauseTag>> {
        return this.table;
    }
}
