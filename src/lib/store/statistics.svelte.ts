...
export const getStatistics = () => { return { noDecisions: statistics.noDecisions, noBacktrackings: statistics.noBacktrackings, noUnitPropagations: statistics.noDecisions } as Statistics };
